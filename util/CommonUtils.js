...
const replaceNewLinesInString = function(str, rplt) {
  if (!(typeof str === 'string' || str instanceof String)) {
    return null;
  }
...
const replaceSpaceCharsInString = function(str, rplt) {
  if (!(typeof str === 'string' || str instanceof String)) {
    return null;
  }
  ...
  return str.replace(/\s/g, rplt);
};

const replaceTabCharsInString = function(str, rplt) {
  if (!(typeof str === 'string' || str instanceof String)) {
    return null;
  }
